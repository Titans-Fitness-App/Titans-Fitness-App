...
app.title("Workout Lessons")
app.geometry(f"{app.winfo_screenwidth()}x{app.winfo_screenheight()}+0+0")


# Set a brighter background color
inspiring_color = "#FFE0BD"
...
# Image directory
image_directory = "New Fitness App"
...
def display_exercise(exercise_name, image_file, instructions):
    ...
    try:
        ...
        back_icon_path = os.path.join(image_directory, "previous button.png")  # Change to your icon filename
...
def load_exercises():
    ...
    quote_label.grid(row=0, column=0, pady=20, sticky="nsew")  # Center the quote using sticky
